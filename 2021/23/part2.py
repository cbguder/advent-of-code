...
class State:
    ...
    def apply_move(self, move):
        ...
        return State(board=new_board), energy
...
ROOM_COORDS = {
    Coord(line, col)
    for line, col in itertools.product(range(2, 6), {3, 5, 7, 9})
}
...
def main():
    ...
    board.insert(3, [x for x in "  #D#C#B#A#\n"])
    board.insert(4, [x for x in "  #D#B#A#C#\n"])
